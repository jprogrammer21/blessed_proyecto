...
-- Tiempo de generación: 23-01-2023 a las 20:03:57
...
--
-- Volcado de datos para la tabla `t_chapter`
--

INSERT INTO `t_chapter` (`chapt_id`, `chatp_uid`, `chapt_name`, `chapt_descrp`, `chatp_condt`, `chatp_video`, `chart_cours_id`, `img`) VALUES
(42, '63cb185c21721', 'capitulo 1', '<p>capitulo uno hablara sobre todo lo de las criptos jajajaja</p>\r\n<ul>\r\n<li>tosmdsad</li>\r\n</ul>\r\n<p>asdasddsasdasd</p>\r\n<p>sadasd</p>\r\n<p>asdasd</p>', '1', '88888', 30, 'public/img/63cb185c213c2gera.png'),
(43, '63cb18f4ac2fe', 'kjhgf', '<p>yhggbgb</p>', '1', '098765432', 30, 'public/img/63cb18f4abf84img12.png');
...
--
-- Volcado de datos para la tabla `t_comments`
--

INSERT INTO `t_comments` (`coment_id`, `comment_uid`, `comment`, `comment_date`, `coment_condt`, `com_chapters_id`, `com_user_id`) VALUES
(38, '63cecbbed1741', '<p>asdsdsd</p>', '2023-01-23', '1', 42, 63),
(39, '63ced31153319', '<p>weje</p>', '2023-01-23', '1', 42, 101);
...
--
-- Volcado de datos para la tabla `t_courses`
--

INSERT INTO `t_courses` (`cours_id`, `cours_uid`, `cours_name`, `cours_descrp`, `cours_condt`, `tpc_plan_id`, `img`) VALUES
(30, '63cb182d1fcbc', 'prueba', '<p>ssddsdsdsdssdsdsdsddssdsdds</p>', '1', 118, 0x7075626c69632f696d672f36336362313832643166363536676561722e706e67);
...
(20, '63cb0905a83b8', '2023-01-20', '2023-02-20', '1', 118, 101),
(21, '63cb1c191d1bd', '2023-01-20', '2023-02-20', '1', 118, 102);
...
--
-- Volcado de datos para la tabla `t_res_coment`
--

INSERT INTO `t_res_coment` (`res_com_id`, `res_com_uid`, `res_comment`, `res_com_date`, `res_com_cond`, `res_user_id`, `res_coment_id`, `res_chapters_id`) VALUES
(2, '63ced2d7ad8d0', '<p>as</p>', '2023-01-23', '1', 63, 38, 42);
...
(118, '63c39de633731', 'prueba', '1', '250000', '1', '<ul>\n<li>cripto</li>\n</ul>'),
(124, '63cae1c7ae216', 'prueba 2', '5', '5555', '2', '<p>asjcbajcsbjasc</p>\n<ul>\n<li>asdasdasd</li>\n<li>adsasdas</li>\n<li>asdasdasd</li>\n</ul>');
