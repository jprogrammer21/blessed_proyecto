            ...
            <div data-bs-spy="scroll" data-bs-target="#navbar-example2" data-bs-root-margin="0px 0px -40%" data-bs-smooth-scroll="true" class="scrollspy-example bg-light p-3 rounded-2" tabindex="0">
                ...
                <div class="card " id="scrollspyHeading1">
                    <div class="card-header">
                        ...
                        <h3 class="card-title"><i class="tim-icons icon-tv-2"></i> <?php echo $chapt_name; ?></h3>
                        <div class="row">
                    ...
                    <div class="card-body">
                        ...
                        <p class="Header 5" style="margin-left: 10px;"><?php echo $chapt_descrp; ?> </p>
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form id="response" action="?controller=comment&action=rep_coments" method="post">
                                                ...
                                                <input type="number" name="chapters_id" id="chapters_id" value="<?php echo $this->datos["chapt_id"]; ?>" style="display:none;">
...
<script>
    var id_coment = "<?php echo $this->datos["chapt_id"]; ?>";
</script>
